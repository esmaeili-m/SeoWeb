        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2 class="mt-4 mr-4">لیست پست ها</h2>
                            <div class="col-12">
                                <div class="row">
                                    <div class="col-2">
                                        <a href="{{route('posts.create')}}">
                                            <button class="mt-5 btn-hover color-8">ساخت پست</button>
                            ...
                            <table class="table table-striped centerTable">
                                ...
                                @foreach($posts as $i)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('posts.update',$i->id)}}">
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            آیا می خواهید پست {{$i->name}}  را حذف کنید ؟
                                                        </div>
